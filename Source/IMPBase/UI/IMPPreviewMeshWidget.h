...
#include "IMPPreviewMeshWidget.generated.h"

/* UI Widget that renders the inventory item preview generated by an AIMPPreviewCaptureBase Actor on screen. */
UCLASS()
class IMPBASE_API UIMPPreviewMeshWidget : public UUserWidget
{
	GENERATED_BODY()
